...
It consists of 10 problems, each worth 10 points, for a total of 100 points. 

\paragraph{Conventions.}
Throughout this paper,
$\mathbb{N}=\{1,2,3,\ldots\}$ (so $0\notin\mathbb{N}$) and
...
Prove that for all $n,m\in\mathbb{N}\setminus\{1\}$ there exist
$x,y,z\in\mathbb{N}$ such that

$$x^n+y^n \equiv z^n \pmod{m}
\qquad\text{and}\qquad
z^n \not\equiv 0 \pmod{m}$$

*:$(0\notin\mathbb{N},x,y,z$are pairwise distinct).
...
We know that knights' movements can be express like this:
